...
import javablossom.helper.annotation.DatePattern;

/**
 * The {@code DateHelper} class is used to provide helper methods for time,
 * date and datetime operations.
 * 
 * @see javablossom.helper.annotation.DatePattern
 */
public class DateHelper {
     ...
     * @throws IllegalAccessException    if the getType method throws an access
     *                                   exception
     */
     ...
     * 
     * @param type The date class type
